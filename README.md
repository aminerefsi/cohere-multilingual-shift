...
4. **Adding labelled target-language examples did not measurably help.** Up to 64 per class moved
   accuracy by at most about 2 points in either direction, within seed noise. The multilingual
